...
namespace WebApiMusic.Services
{
    public class EscribirEnArchivo : IHostedService
    {
        
        private readonly IWebHostEnvironment env;
        private readonly string nombreArchivo = "ListadoArtistas.txt";
        private Timer timer;
        ...
        public Task StartAsync(CancellationToken cancellationToken)
        {
            ...
            timer = new Timer(DoWork, null, TimeSpan.Zero, TimeSpan.FromSeconds(6));
